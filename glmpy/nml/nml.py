...
#     @strict.setter
#     def strict(self, value: bool):
#         for nml_param in self.values():
#             if isinstance(nml_param, NMLParam):
#                 nml_param.strict = value
#         self._strict = value

#     def __getitem__(self, key: Any) -> NMLParam:
#         return super().__getitem__(key)
...
#     def validate(self):
#         if self.strict:
#             for param_name, nml_param in self.items():
#                 if isinstance(nml_param, NMLParam):
#                     nml_param.validate()
...
# class NMLParamDict(UserDict):
#     def __init__(self, *args, **kwargs):
#         self._strict = False  
#         super().__init__(*args, **kwargs)

#     def __getstate__(self):
#         return (self.strict, self.data.copy())

#     def __setstate__(self, state):
#         self._strict, data_dict = state
#         self.data = data_dict
...
#     @strict.setter
#     def strict(self, value: bool):
#         for nml_param in self.data.values():
#             if isinstance(nml_param, NMLParam):
#                 nml_param.strict = value
#         self._strict = value
...
#     def validate(self):
#         if self.strict:
#             for param_name, nml_param in self.data.items():
#                 if isinstance(nml_param, NMLParam):
#                     nml_param.validate()

#     def __str__(self) -> str:
#         param_dict = {}
#         for key, nml_param in self.data.items():
#             param_dict[key] = nml_param.value
#         return str(param_dict)    
...
#     @strict.setter
#     def strict(self, value: bool):
#         for nml_block in self.values():
#             if isinstance(nml_block, NMLBlock):
#                 nml_block.strict = value
#         self._strict = value

#     def __getitem__(self, key: Any) -> NMLBlock:
#         return super().__getitem__(key)
...
#                 raise KeyError(
#                     "Adding additional blocks is restricted when the "
#                     "`strict` attribute is set to False. Set `strict` to True "
#                     "to override this error."
#                 )
#         if not isinstance(value, NMLBlock) and value is not None:
#             raise TypeError(
...
#                 if isinstance(nml_block, NMLBlock):
#                     nml_block.validate()
#                 elif nml_block is not None:
#                     raise TypeError(
#                         f"{block_name} is not of type NMLBlock or None."
#                     )
...
#     @strict.setter
#     def strict(self, value: bool):
#         for nml in self.values():
#             if isinstance(nml, NML):
#                 nml.strict = value
#         self._strict = value

#     def __getitem__(self, key: Any) -> NML:
#         return super().__getitem__(key)
...
#         nml_string = ""
#         #nml_string += f"! glm-py {glmpy.__version__}\n"
